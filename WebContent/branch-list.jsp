...
<html>
<head>
	<title>Branch - GoCheetha Taxi</title>
	...
	<div class="main-wrapper">
			        ...
			        <div class="card">
			            <div class="card-body p-2 p-md-3">
			                ...
			                <div class="text-center float-md-right">
			                    <a href="BranchControllerServlet?command=SHOW-ADDDATA" class="btn btn-outline-primary btn-icon-text">
			                ...
			                <div id="divRecords" class="m-0 p-0 mt-2">
								<div class="table-responsive">
									<table class="table table-centered table-nowrap table-striped">
										...
										<tbody id="tblBody">
											 <c:forEach items="${branch_lists}" var="branch_lists">

                                                    <tr id="row_${branch_lists.branch_Id}">
                                                        <td class="d-none">${branch_lists.branch_Id}</td>
                                                        <td>${branch_lists.branch_Name}</td>
                                                        <td class="d-none">${branch_lists.city_Id}</td>
                                                        <td>${branch_lists.city_Name}</td>
														<td>
										                    <a href="BranchControllerServlet?command=SHOW-UPDATE&id=${branch_lists.branch_Id}" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i></a>
										                    <a href="javascript:void(0);" onclick="ConfirmDelete('${branch_lists.branch_Id}')"  class="table-icon text-danger"> <i class="mdi mdi-delete"></i></a>
										                </td>
													</tr>
											</c:forEach>
										</tbody>
 	...
 	$(document).ready(function () {
	 	...
	 	var DeleteRecord = function (){
	            ...
	            var url = 'BranchControllerServlet';

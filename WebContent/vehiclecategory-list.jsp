...
<html>
<head>
	<title>Vehicle Category - GoCheetha Taxi</title>
	...
	<div class="main-wrapper">
		...
		<div class="page-content">
	        ...
	        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
		          <div>
		            <h4 class="mb-3 mb-md-0">Vehicle Category</h4>
		          </div>
            </div>
			        ...
			        <div class="card">
			            <div class="card-body p-2 p-md-3">
			                ...
			                <div class="text-center float-md-right">
			                    <a href="VehicleCatControllerServlet?command=SHOW-ADDDATA" class="btn btn-outline-primary btn-icon-text">
			                ...
			                <div id="divRecords" class="m-0 p-0 mt-2">
								<div class="table-responsive">
									<table class="table table-centered table-nowrap table-striped">
										...
										<tbody id="tblBody">
											<c:forEach items="${Category_lists}" var="Category_lists">

                                                    <tr id="row_${Category_lists.vehicle_category_Id}">
                                                        <td class="d-none">${Category_lists.vehicle_category_Id}</td>
                                                        <td>${Category_lists.vehicle_type_Name}</td>
                                                        <td>${Category_lists.service_Charge}</td>
                                                        <td>${Category_lists.charge_per_Km}</td>
														<td>
										                    <a href="VehicleCatControllerServlet?command=SHOW-UPDATE&id=${Category_lists.vehicle_category_Id}" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i></a>
									                    	<a href="javascript:void(0);" onclick="ConfirmDelete('${Category_lists.vehicle_category_Id}')" class="table-icon text-danger"> <i class="mdi mdi-delete"></i></a>
									                </td>
												</tr>
											</c:forEach>
										</tbody>
 	...
 	<script title="Task">
 	 ...
 	 $(document).ready(function () {
	 	...
	 	var DeleteRecord = function (){
	            ...
	            var url = 'VehicleCatControllerServlet';

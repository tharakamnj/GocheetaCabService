...
<html>
<head>
	<title>Employee - GoCheetha Taxi</title>
			                ...
			                <div id="divRecords" class="m-0 p-0 mt-2">
								<div class="table-responsive">
									<table class="table table-centered table-nowrap table-striped">
										...
										<tbody id="tblBody">
											<c:forEach  items="${employee_lists}" var="employee_lists">
													
												<tr id="row_${employee_lists.employee_Id}">
													<td class="d-none">${employee_lists.employee_Id}</td>
													<td>${employee_lists.display_Name}</td>
													<td>${employee_lists.username}</td>
													<td>${employee_lists.email}</td>
													<td>${employee_lists.userType}</td>
													<td>
									                  
									                	<a href="javascript:void(0);" onclick="ConfirmDelete('${employee_lists.employee_Id}')" class="table-icon text-danger"> <i class="mdi mdi-delete"></i></a>
									                </td>
												</tr>
											</c:forEach>
										</tbody>

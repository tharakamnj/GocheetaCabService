...
<html>
<head>
	<title>Update Street - GoCheetha Taxi</title>
	...
	<div class="main-wrapper">
		...
		<div class="page-content">
	        ...
	        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
		          <div>
		            <h4 class="mb-3 mb-md-0">Update Street</h4>
		          </div>
            </div>
					  ...
					  <form action="StreetControllerServlet" method="post">
		                   <div class="alert alert-danger col-md-12 ${exceptionerrorshow}" id="divShowError" role="alert">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-8">
                                    <select name="cmbCityId" class="form-control" id="cmbCityId">
                                        <c:forEach items="${cityDrp}" var="city">
                                            <option value="${city.city_Id}">${city.city_Name}</option>
                                        </c:forEach>
                                    </select>

                                    <input type="text" class="form-control d-none" name="city_Id" id="txtcity_Id" value="${street.city_Id }" placeholder="Select City">
                                </div>
                            </div>							

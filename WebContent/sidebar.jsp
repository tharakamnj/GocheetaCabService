...
<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="resources/img/logo.svg" alt="navbar brand" class="navbar-brand">
				</a>
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="LoginControllerServlet">Logout</a>
									</li>
								</div>
							</ul>
						</li>
					...
					<div class="sidebar-content">
						<ul class="nav nav-warning">
							...
							<li class="nav-item ${param.street}">
								<a href="StreetControllerServlet">
							...
							<li class="nav-item ${param.branch}">
								<a href="BranchControllerServlet">
									<i class=" fas fa-layer-group"></i>
									<p>Branch</p>
							...
							<li class="nav-item ${param.vehiclecategory}">
								<a href="VehicleCatControllerServlet">
									<i class=" fas fa-layer-group"></i>
							...
							<li class="nav-item ${param.driver}">
								<a href="DriverControllerServlet">
									<i class=" fas fa-layer-group"></i>
									<p>Driver Details</p>

...
<html>
<head>
	<title>City - GoCheetha Taxi</title>
			        ...
			        <div class="card">
			            <div class="card-body p-2 p-md-3">
			                ...
			                <div class="text-center float-md-right">
			                    <a href="CityControllerServlet?command=SHOW-ADDDATA" class="btn btn-outline-primary btn-icon-text">
			                ...
			                <div id="divRecords" class="m-0 p-0 mt-2">
								<div class="table-responsive">
									<table class="table table-centered table-nowrap table-striped">
										...
										<tbody id="tblBody">
											<c:forEach  items="${city_lists}" var="city_lists">
													
												<tr id="row_${city_lists.city_Id}">
													<td class="d-none">${city_lists.city_Id}</td>
													<td>${city_lists.city_Name}</td>
													<td>
									                    <a href="CityControllerServlet?command=SHOW-UPDATE&id=${city_lists.city_Id}" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i></a>
									            
									                	<a href="javascript:void(0);" onclick="ConfirmDelete('${city_lists.city_Id}')" class="table-icon text-danger"> <i class="mdi mdi-delete"></i></a>
									                </td>
												</tr>
											</c:forEach>
										</tbody>
